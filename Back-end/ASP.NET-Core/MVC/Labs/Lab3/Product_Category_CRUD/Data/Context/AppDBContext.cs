...
namespace Product_Category_CRUD.Data.Context
{
    public class AppDBContext : DbContext
    {
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            string connectionString = "Server=.\\SQLEXPRESS;DataBase=Products_Category_Lab3;Trusted_Connection=true;TrustServerCertificate=true";
